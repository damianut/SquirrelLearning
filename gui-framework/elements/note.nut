...
#public:
	...
	function updateVisibleLines()
	{
		...
		textSetFont(m_font)
		m_visibleLinesCount = (getSizePx().height - margin.top - margin.bottom - textHeightPx(m_text))/m_lineSpacingPx
	...
	function setFont(font)
	{
		...
		textSetFont(font)
		setLineSpacingPx(textHeightPx("X"))
		textSetFont(oldFont)
	}
